...
WUT_XMOD void wut_ele_hdl_scrollbar(struct wut_Element *ele)
{
        ...
        /* We need to keep the active tracking flags alive */
        org_flag = ele->scrollbar_flags & 31;

        ele->scrollbar_flags = org_flag | (flag & ele->style.scrollbar_flags);
}
