...
"    fs_bcolor = u_bcolor[in_index];\n"
""
"    gl_Position = vec4((in_position.x - lframe.x) / lframe.x, (lframe.y - in_position.y) / lframe.y, 0, 1);\n"
"}\0";
...
"    \n"
"    if(corner < 0) {\n"
"        if(loc.y <= fs_sides[0] + fs_bwidth || loc.x >= fs_sides[1] - fs_bwidth || loc.y >= fs_sides[2] - fs_bwidth || loc.x <= fs_sides[3] + fs_bwidth) color = fs_bcolor;\n"
"        else color = fs_color;\n"
"    }\n"
"    else {\n"
