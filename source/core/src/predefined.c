...
"	switch(in_type) {"
"		case 1:"
"			ivec4 lradius = u_radius[in_index.y];"
"			fs_color = u_color[in_index.y];"
"			fs_cpoints = vec2[4]("
...
"			);"
"			fs_radius = lradius;"
"			fs_bwidth = u_bwidth[in_index.y];"
"			fs_bcolor = u_bcolor[in_index.y];"
"			fs_scroll = ivec2(0, 0);"
"			break;"
...
"	int scrollbar_thumb_position[2] = {50, 20};"
"	int scrollbar_thumb_size[2] = {200, 100};"
""
"	switch(fs_type) {"
"		case 1:"
...
""
"		case 2:"
"			if(loc.y > fs_sides[0] + 1 + fs_scroll[0] && loc.x < fs_sides[1] - 1 && loc.y < fs_sides[0] + 1 + fs_scroll[0] + fs_scroll[1] && loc.x > fs_sides[3] + 1) {"
...
"			break;"
"		case 3:"
"			if(loc.y > fs_sides[0] + 1 && loc.x < fs_sides[3] + 1 + fs_scroll[0] + fs_scroll[1] && loc.y < fs_sides[2] - 1 && loc.x > fs_sides[3] + 1 + fs_scroll[0]) {"
"				out_color = vec4(1, 0, 1, 1);"
"			}"
"			else {"
"				out_color = vec4(1, 1, 0, 1);"
